...
def generate_sitemap_xml(pages_data, base_url="https://research.xiaowenz.com"):
    """生成 sitemap.xml 文件"""
...
def generate_robots_txt(base_url="https://research.xiaowenz.com"):
    """生成 robots.txt 文件"""
...
if __name__ == '__main__':
    ...
    if success_pages:
        ...
        try:
            ...
            # 生成 sitemap.xml
            base_url = input("请输入网站的基础 URL (例如: https://research.xiaowenz.com): ").strip()
            if not base_url:
                base_url = "https://research.xiaowenz.com"
